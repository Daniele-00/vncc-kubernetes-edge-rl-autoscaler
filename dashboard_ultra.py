...
while True:
    ...
    with placeholder.container():
        ...
        with colA:
            ...
            # 👇 QUI aggiungo key univoca
            st.plotly_chart(fig, use_container_width=True, theme="streamlit", key="latency_replicas_chart")
        ...
        with colB:
            ...
            st.plotly_chart(fig_r, use_container_width=True, theme="streamlit", key="reward_chart")
